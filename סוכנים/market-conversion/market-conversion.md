...
description: Conversion rate optimization subagent. Spawned by /market audit (subagent 2) to find conversion barriers and friction, including CTAs, forms, visual hierarchy, trust signals, and pricing page effectiveness.
tools: [WebFetch]
---
