...
description: Technical marketing analysis subagent. Spawned by /market audit (subagent 4) to evaluate SEO infrastructure, site performance, tracking setup, and content architecture of a target website.
tools: [Read, WebFetch]
---
